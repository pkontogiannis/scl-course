...
$c_Lcalculator_Calculator$.prototype.computeValues__sci_Map__sci_Map = (function(namedExpressions) {
  ...
  namedExpressions.foreach__F1__V(new $c_Lcalculator_Calculator$$anonfun$computeValues$1().init___sci_Map__sr_ObjectRef(namedExpressions, res));
  return $as_sci_Map(res.elem$1)
});
$c_Lcalculator_Calculator$.prototype.eval__Lcalculator_Expr__sci_Map__D = (function(expr, references) {
  _eval: while (true) {
    if ($is_Lcalculator_Literal(expr)) {
      var x2 = $as_Lcalculator_Literal(expr);
      var v = x2.v$2;
      return v
    } else if ($is_Lcalculator_Ref(expr)) {
      continue _eval
    } else if ($is_Lcalculator_Plus(expr)) {
      var x4 = $as_Lcalculator_Plus(expr);
      var v1 = x4.a$2;
      var v2 = x4.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(v1, references) + this.eval__Lcalculator_Expr__sci_Map__D(v2, references))
    } else if ($is_Lcalculator_Minus(expr)) {
      var x5 = $as_Lcalculator_Minus(expr);
      var v1$2 = x5.a$2;
      var v2$2 = x5.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(v1$2, references) - this.eval__Lcalculator_Expr__sci_Map__D(v2$2, references))
    } else if ($is_Lcalculator_Times(expr)) {
      var x6 = $as_Lcalculator_Times(expr);
      var v1$3 = x6.a$2;
      var v2$3 = x6.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(v1$3, references) * this.eval__Lcalculator_Expr__sci_Map__D(v2$3, references))
    } else if ($is_Lcalculator_Divide(expr)) {
      var x7 = $as_Lcalculator_Divide(expr);
      var v1$4 = x7.a$2;
      var v2$4 = x7.b$2;
      return (this.eval__Lcalculator_Expr__sci_Map__D(v1$4, references) / this.eval__Lcalculator_Expr__sci_Map__D(v2$4, references))
    } else {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.init___sci_Map__sr_ObjectRef = (function(namedExpressions$1, res$1) {
...
$c_Lcalculator_Calculator$$anonfun$computeValues$1.prototype.apply__T2__V = (function(x0$1) {
  if ((x0$1 !== null)) {
    var str = $as_T(x0$1.$$und1$f);
    var exp = $as_Lcalculator_Signal(x0$1.$$und2$f);
    var jsx$2 = this.res$1$2;
    var jsx$1 = $as_sci_Map(this.res$1$2.elem$1);
    $m_Lcalculator_Signal$();
    var expr = new $c_sjsr_AnonFunction0().init___sjs_js_Function0((function(arg$outer, str$1, exp$1) {
      return (function() {
        return $m_Lcalculator_Calculator$().eval__Lcalculator_Expr__sci_Map__D($as_Lcalculator_Expr(exp$1.apply__O()), $as_sci_Map(arg$outer.namedExpressions$1$f.$$minus__O__sc_Map(str$1)))
      })
    })(this, str, exp));
    var y = new $c_Lcalculator_Signal().init___F0(expr);
    jsx$2.elem$1 = jsx$1.$$plus__T2__sci_Map(new $c_T2().init___O__O(str, y))
  } else {
    throw new $c_s_MatchError().init___O(x0$1)
  }
});
